...
public class Fragment3dels extends AppCompatDialogFragment {
    String number,name;
    Button yes,no;
    TextView deltext;
    ...
    public Dialog onCreateDialog (Bundle savedInstanceState)
    {
        ...
        yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatabaseReference delref = FirebaseDatabase.getInstance().getReference("staff").child(number.split("@")[0]);
                delref.removeValue();
